...
const PortfolioItem = ({ title, link }) => (
  <div className='about-me__portfolio-box'>
    <a href={link} target='_blank' rel='noopener noreferrer' className='about-me__portfolio-title-link'>
      <p className='about-me__portfolio-title'>{title}</p>
      <img src={require('../../images/arrowLink.svg').default} alt='Ссылка' className='about-me__portfolio-link-img' />
    </a>
      ...
      <div className='about-me__container'>
        ...
        <div className='about-me__container-second'>
          ...
          <div className='about-me-portfolio-container'>
            <PortfolioItem title='Статичный сайт' link='https://kirill23111.github.io/how-to-learn/' />
            <PortfolioItem title='Адаптивный сайт' link='https://kirill23111.github.io/russian-travel/' />
            <PortfolioItem title='Одностраничное приложение' link='https://mestoproject.nomoredomainsmonster.ru' />
          </div>
        </div>
      </div>
    </div>
